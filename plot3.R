...
with(electrics, plot(x = Date, y = Sub_metering_1, type = "l", xlab = "",
                     ylab = "Energy sub metering"))
with(electrics, points(x = Date, y = Sub_metering_2, type = "l", col = "red"))
with(electrics, points(x = Date, y = Sub_metering_3, type = "l", col = "blue"))
